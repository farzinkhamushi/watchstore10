                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control text-left" dir="rtl" name="price">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control text-left" dir="rtl" name="discount">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea dir="rtl" class="form-control" id="description" name="description" rows="10" cols="30"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-3">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="customCheck" dir="rtl" name="is_special">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="text-left form-control" dir="rtl" id="special_expiration" name="special_expiration">
                            </div>
                        </div>
