...
class PropertyGroupController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('property-groups.index')->with('message','گروه ویژگی ها با موفقیت ایجاد شد');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('property-groups.index')->with('message','گروه ویژگی ها با موفقیت ویرایش شد');
    }
